...
from tools.tools import with_language, owner_only, Messages
...
async def bot_statistics(_, query: CallbackQuery, language: str):
    ...
    await query.edit_message_text(messages.statistics.format(users, active_users, chats, active_chats), reply_markup=back)
